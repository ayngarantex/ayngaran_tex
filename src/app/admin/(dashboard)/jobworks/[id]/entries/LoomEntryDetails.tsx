...
export default function LoomEntryDetails({ looms, entry }: { looms: any[], entry?: any }) {
  ...
  const canSave = entries.some((row) => row.date || row.type || row.details || row.weight !== '' || row.loomId !== '');
