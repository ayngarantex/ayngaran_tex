...
import PaymentForm from './payment-form';
import { createYarn } from '@/app/api/node/yarns';
...
export default function Form({
  ...
  const [selectedSuplier, setSelectedSupplier] = useState<SupplierField | null>(null);
  ...
  const handleSubmit = async () => {
    ...
    const invoiceData = {
      SupplierId: selectedSuplier?.SupplierId,
    ...
    try {
      const data = await createYarn({
        invoiceData,
        products: yrnProducts,
        payments: payments
      });
      ...
      <div className="rounded-md bg-blue-50 p-4 md:p-6">
          ...
          <div className="mb-4 w-full">
            ...
            <div className="relative mt-2 rounded-md">
              <input
                ...
                name="gstNumber"
                type="text"
                value={selectedSuplier?.GstNumber || ''}
                readOnly
        ...
        {billType === 'gst' ?
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 pt-6'>
            ...
            {selectedSuplier?.State === 'TamilNadu' ?
              <>
                <div className="mb-4 w-full">
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                className="peer block w-full rounded-md border border-gray-200 py-2 pl-4 text-lg outline-2 placeholder:text-gray-500"
              />
            </div>
          </div>
        </div>
