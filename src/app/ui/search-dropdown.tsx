...
export default function SearchDropdown({
    ...
    return (
        <div className={`${className || (hideLabel ? "" : "")}`} >
            {!hideLabel && (
            ...
            <div className="flex mr-3">
                <div className={`relative flex-1 ${createLink ? 'mr-3' : ''}`} ref={ref}>
                    ...
                    <input
                        ...
                        className={`peer block w-full cursor-pointer rounded-md border border-gray-200 bg-white py-2 ${showUserIcon ? 'pl-10' : 'pl-3'} text-sm outline-2 placeholder:text-gray-500 h-10`}
                    />
                    {showDropdown && (
